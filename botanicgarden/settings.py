"""
Django settings for botanicgarden project.
...
WSGI_APPLICATION = 'botanicgarden.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'USER': 'doadmin',
        'PASSWORD': '',
        'HOST': 'dbaas-db-2773019-do-user-16585818-0.c.db.ondigitalocean.com',
        'PORT': '25060',
        'OPTIONS':{
            'ssl': {
